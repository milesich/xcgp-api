---
title: AchievementChainConnection
---
...
## Schema definition
```graphql
type AchievementChainConnection {

  # Information to aid in pagination.
  pageInfo: PageInfo!

  # Information to aid in pagination
  edges: [AchievementChainEdge]
...
* **edges ([`[AchievementChainEdge]`](graphql/schema/achievementchainedge.md))**
...
* **achievementChains ([`[AchievementChain]`](graphql/schema/achievementchain.md))**
