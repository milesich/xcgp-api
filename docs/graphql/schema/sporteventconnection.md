...
## Schema definition
```graphql
type SportEventConnection {

  # Information to aid in pagination.
  pageInfo: PageInfo!

  # Information to aid in pagination
  edges: [SportEventEdge]
...
* **edges ([`[SportEventEdge]`](graphql/schema/sporteventedge.md))**
...
* **sportEvents ([`[SportEvent]`](graphql/schema/sportevent.md))**
